...
import { BookOpen, Clock, Target, Lightbulb, TrendingUp, ArrowLeft, CheckCircle2 } from 'lucide-react';
...
export function RecommendationResult({ recommendation, onReset }: RecommendationResultProps) {
  return (
