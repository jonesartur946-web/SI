        ...
        <Tabs defaultValue="study" className="w-full">
          ...
          <TabsContent value="study" className="mt-0">
            {!studyRecommendation ? (
              ...
              <RecommendationResult recommendation={studyRecommendation} onReset={handleStudyReset} />
            )}
          </TabsContent>
          ...
          <TabsContent value="career" className="mt-0">
            {!careerRecommendation ? (
              ...
              <CareerResult recommendation={careerRecommendation} onReset={handleCareerReset} />
            )}
          </TabsContent>
        </Tabs>
      </main>
